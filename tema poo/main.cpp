...
while(true){
    ...
    cin>>x;
    switch(x){
    case 1 : cin>>selected; --selected; break;
    case 2 : cin>>c[selected]; break;
    case 3 : cout<<c[selected]; break;
    case 4 : c[selected].del_start(); break;
    case 5 : c[selected].rev(); break;
    case 6 : cout<<"cati pasi"<<endl; cin>>k; c[selected].k_del(k); break;
    case 7 : c[2]=c[0]+c[1]; cout<<c[2]<<endl; break;
    default: return 0;
    }
